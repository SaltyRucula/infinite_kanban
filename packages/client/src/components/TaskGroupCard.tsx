...
export function TaskGroupCard({ group, onClickGroup, onRunGroup, onStopGroup, onDeleteGroup, onEditGroup }: TaskGroupCardProps) {
  ...
  const isRunning = status.executing > 0 || status.planning > 0 || status.awaitingClarification > 0;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs text-zinc-500">
        ...
        {status.awaitingClarification > 0 && <span className="flex items-center gap-1">{statusIcon('awaiting_clarification', 'h-3 w-3')} {status.awaitingClarification} awaiting clarification</span>}
