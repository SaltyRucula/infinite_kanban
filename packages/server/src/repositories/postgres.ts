...
function rowToTask(row: TaskRow): Task {
  ...
  return {
    ...
    workerClaimedAt: row.worker_claimed_at != null ? Number(row.worker_claimed_at) : undefined,
    workerLeaseExpiresAt: row.worker_lease_expires_at != null ? Number(row.worker_lease_expires_at) : undefined,
